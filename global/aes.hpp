...
namespace OKps::AES
{
    ...
    */
    ...
    private:
        ...
        末尾对齐
        */
        static void INNER_make_align(std::byte * buffer, const unsigned int count);

        static void INNER_make_align(char * buffer, const unsigned int count);
