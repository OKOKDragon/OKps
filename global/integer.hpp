    ...
    */
    ...
    private:
        ...
        */
        ...
        如果this < right则返回samller
        */
        compare_result INNER_compare_number(integer const & right)const;
        //比较this和right
        compare_result INNER_compare(integer const & right)const;
        /*
        去掉数组中所有前置的0
    ...
    public:
        ...
        bool operator >(integer const & right)const;
        bool operator <(integer const & right)const;
        bool operator >=(integer const & right)const;
        bool operator <=(integer const & right)const;
        ...
        */
        field_stream field_stream()const;
        /*
        读取2进制流并生成大整数
        */
        integer(OKps::field_stream const & input);
        /*
        将大整数转换为字符串
        如果是负数，则前面加负号
        如果不是负数，则不会加正号
