...
namespace OKps
{
    ...
    */
    ...
    public:
        ...
        safe_data(safe_data const & origin)
            : MEMBER_data(origin.MEMBER_data)
        {
        }
        void operator=(safe_data const & origin)
        {
        ...
        void operator=(safe_data && origin)
        {
        ...
        data_type get() const
        {
            aes::string_device::random_InvCipher(this->MEMBER_data);
            block<data_type> TEMP_content = this->MEMBER_data;

            data_type result = TEMP_content.at(0);
            aes::string_device::random_Cipher(this->MEMBER_data);
        ...
        void set(data_type input)
        {
            ...
            this->MEMBER_data = static_cast<std::string>(TEMP_content);
            aes::string_device::random_Cipher(this->MEMBER_data);
        }
    };
