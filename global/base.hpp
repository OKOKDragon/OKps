...
同样地，基类都有 & 操作符，返回值是this指针，这样就不用写 {std::addressof(obj.self())}，而可以直接写 {&obj}。
...
namespace OKps::base
{
	...
	*/
	...
	public:
		...
		virtual move_invalid * operator &()noexcept override;
		virtual move_invalid const * operator &()const noexcept override;
	...
	*/
	...
	public:
		...
		virtual numbered * operator &()noexcept override;
		virtual numbered const * operator &()const noexcept override;
	...
	*/
	...
	public:
		...
		virtual named * operator &()noexcept override;
		virtual named const * operator &()const noexcept override;
	...
	*/
	...
	public:
		...
		virtual handler * operator &()noexcept override;
		virtual handler const * operator &()const noexcept override;
		/*
	...
	*/
	...
	public:
		...
		virtual marked * operator &()noexcept override;
		virtual marked const * operator &()const noexcept override;
	...
	public:
		...
		virtual reference const * operator &()const noexcept override;
	...
	*/
	...
	public:
		...
		virtual self_copier * operator &()noexcept override;
		virtual self_copier const * operator &()const noexcept override;
		/*
	...
	*/
	...
	public:
		...
		virtual worker * operator &()noexcept override;
		virtual worker const * operator &()const noexcept override;
	protected:
