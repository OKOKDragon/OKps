...
namespace OKps
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        static void operator delete[](void *, std::align_val_t, const std::nothrow_t &) noexcept = delete;
        static void * operator new(size_t, const std::nothrow_t &) = delete;
        static void * operator new[](size_t, const std::nothrow_t &) = delete;
        static void * operator new(size_t, std::align_val_t, const std::nothrow_t &) = delete;
        static void * operator new[](size_t, std::align_val_t, const std::nothrow_t &) = delete;
    ...
    */
    ...
    public:
        ...
        static void * operator new(size_t, std::align_val_t) = delete;
        static void * operator new[](size_t, std::align_val_t) = delete;
