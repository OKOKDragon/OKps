...
namespace OKps
{
    ...
    */
    ...
    private:
        // static void ERROR_null_pointer(void const *const block);
        static void ERROR_allocate_fail();
        // static void BASIC_pool_input(void *block, const std::size_t size);
    ...
    protected:
        ...
        void operator=(const basic &) noexcept;
        void operator=(basic &&) noexcept;
